...
exports.getStorageClient = async (ctx) => {
    function getStorageClient() {
        ...
        const url = `${ctx.configuration.fusebit_audience}/v1/account/${ctx.configuration.fusebit_account_id}/subscription/${ctx.configuration.fusebit_subscription_id}/storage/${ctx.configuration.fusebit_storage_id}`;
